...
const ConfirmSeed = styled.div`
	...
	.shuffled-seed li:hover,
	.shuffled-seed__li--activate {
			...
			<ConfirmSeed>
				...
				<div className='textcontain'>
					...
					<p className='extramargin'>
						{t(
							'Please re-enter your seed words and passphrase in full from the previous step. This is to confirm that you have correctly recorded these down.'
						)}
					</p>
				</div>
				...
				<Container>
					<ul className='ordered-seed'>
						{sortedSeed.map((word, key) => (
							<li
								onClick={onOrderedWordClick(word, key)}
								className={`shuffled-ordered__li`}
								key={key}
							>
								{word} <i className='fa fa-times'></i>
							</li>
						))}
					</ul>
					<ul className='shuffled-seed'>
						{shuffledSeed.map((word, key) => (
							<li
								onClick={onShuffledWordClick(word, key)}
								className={`shuffled-seed__li`}
								key={key}
							>
								{word}
							</li>
